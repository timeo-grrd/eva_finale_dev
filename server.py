...
sorties = [
    ...
    {"id": 3, "titre": "Match de foot amateur", "categorie": "sport", "budget": 5, "description": "Jouer ou regarder un match de football entre étudiants.", "note": 3},
    {"id": 4, "titre": "Dîner street food", "categorie": "food", "budget": 15, "description": "Découvrir différents stands de street food pour un repas varié.", "note": 0},
    {"id": 5, "titre": "Visite de musée gratuit", "categorie": "culture", "budget": 0, "description": "Explorer un musée lors d'une journée gratuite ou à tarif réduit.", "note": 2},
    ...
    {"id": 9, "titre": "Bowling entre amis", "categorie": "jeu", "budget": 15, "description": "Passer une soirée fun à enchaîner les strikes au bowling.", "note": 2},
    ...
    {"id": 13, "titre": "Marché local", "categorie": "culture", "budget": 10, "description": "Découvrir les produits locaux et l'ambiance d'un marché.", "note": 3},
    ...
    {"id": 19, "titre": "Exposition photo", "categorie": "culture", "budget": 10, "description": "Explorer une exposition artistique inspirante.", "note": 2},
    ...
    {"id": 21, "titre": "Soirée chill musique", "categorie": "divertissement", "budget": 0, "description": "Écouter de la musique et discuter dans une ambiance détendue.", "note": 3},
    ...
    {"id": 23, "titre": "Cours de yoga", "categorie": "sport", "budget": 10, "description": "Se détendre avec une séance de yoga accessible à tous.", "note": 3},
